...
- [x] 8. A Choose-Your-Own-Adventure wouldn’t be any fun if it weren’t interactive. Let’s explore how we can take input from the user. Outside of the TreeNode class, declare a variable user_choice and assign it to input("What is your name? ")


- [x] 9. Immediately below input(), print out user_choice and click “Save”.

- [x] 10. Inside of the terminal type python3 script.py to run our program.
...
- [x] 11. Did you see your name printed out?
...
## Adding Chapters
- [x] 12. Every good story has a beginning, middle, and end. Let’s alter our TreeNode class so we can add the middle and end.

We’ll need an .add_child() method defined within TreeNode that has self and node as parameters.

- [x] 13. We’re treating each node in the tree as a piece of the story. It’s a Choose-Your-Own-Adventure story, so there are multiple paths the user can take.

Store the argument passed into add_child() inside of self.choices.

- [x] 14. Let’s add a few more pieces of the story.
...
2 ) Yell 'Hooray!'
"""
- [x] 15. Declare choice_b and assign it to a new instance of TreeNode with the following argument:
...
"""
- [x] 16. Call add_child() on story_root and pass choice_a as an argument.

- [x] 17. Call add_child() on story_root and pass choice_b as an argument.

- [x] 18. Wonderful! Now our story has a beginning in the variable story_root, and two choices available for a middle section stored inside of story_root.choices.

## Our Story So Far
- [x] 19. Let’s add some functionality to our TreeNode class so we can move through the story.

Within TreeNode, define .traverse(). It should only take self as an argument.

- [x] 20. Inside of .traverse(), declare a variable story_node and assign it to self. This variable will track the current portion of the story.

Call print() with story_node.story_piece as an argument.

- [x] 21. Test out our .traverse() method by calling it on story_root.
...
- [x] 22. We want to take user input and progress through the story as long as there are story choices remaining.
...
- [x] 23. Let’s write out the while loop that will make up the rest of .traverse().
...
- [x] 24. Inside of the while loop, declare a variable choice and set it to input() with the argument: "Enter 1 or 2 to continue the story: ".

This is how we will collect the user’s choice for how to progress through the story.

- [x] 25. Let’s use a conditional to ensure the user is entering valid input.

If choice is not in a list with the valid options, then print out a message asking them to enter a valid choice: 1 or 2.

- [x] 26. Now let’s write the branch of the conditional where the user has made a valid choice.
...
- [x] 27. We’re having our users enter 1 or 2, but the story_node.choices are at index 0 or 1.

Reassign chosen_index to be one less than it was before.

- [x] 28. Declare a variable chosen_child and assign it to the appropriate choice from story_node.choices.

Use chosen_index to access the correct element!

- [x] 29. chosen_child is now our current portion of the story because the user selected this child node.

Use print() to display chosen_child.story_piece.

- [x] 30. Finally, set story_node to be chosen_child.

Our while loop will keep checking story_node to see if there are more choices to be made in our story.

- [x] 31. Congratulations! We have a functioning Choose-Your-Own-Adventure.
...
## The Final Chapter
- [x] 32. Our functionality is all in place, all we have left to do is finish the story. Let’s create the child nodes for choice_a.
...
"""
- [x] 33. Declare a variable choice_a_2 and assign it to an instance of TreeNode with the following string as an argument:
...
YOU REMAIN LOST.
"""
- [x] 34. choice_a_1 and choice_a_2 should be child nodes to choice_a.

Call .add_child() on choice_a to set up the relationship between these nodes.

- [x] 35. Click “Save” and in the terminal run python3 script.py. Navigate through these new sections of the story.

- [x] 36. Now let’s create the child nodes for choice_b.
...
YOU REMAIN LOST.
"""
- [x] 37. Declare a variable choice_b_2 and assign it to an instance of TreeNode with the following string as an argument:
...
YOU HAVE ESCAPED THE WILDERNESS.
"""
- [x] 38. Set up the appropriate relationship for choice_b_1 and choice_b_2; they should be child nodes of choice_b.

- [x] 39. Our story is complete. Click “Save” and run python3 script.py in the terminal.
